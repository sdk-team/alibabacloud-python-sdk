...
class GetNatGatewayConvertStatusResponse(TeaModel):
    def __init__(self, request_id=None, nat_gateway_id=None, bid=None, ali_uid=None, dst_nat_type=None,
                 convert_steps=None):
        self.request_id = request_id
        self.nat_gateway_id = nat_gateway_id
        self.bid = bid
    ...
    def validate(self):
        ...
        self.validate_required(self.dst_nat_type, 'dst_nat_type')
        self.validate_required(self.convert_steps, 'convert_steps')
    ...
    def from_map(self, map={}):
        ...
        self.dst_nat_type = map.get('DstNatType')
        self.convert_steps = []
        if map.get('ConvertSteps') is not None:
            for k in map.get('ConvertSteps'):
                temp_model = GetNatGatewayConvertStatusResponseConvertSteps()
                self.convert_steps.append(temp_model.from_map(k))
        else:
            self.convert_steps = None
        return self


class GetNatGatewayConvertStatusResponseConvertSteps(TeaModel):
    def __init__(self, step_name=None, step_status=None, step_start_time=None):
    ...
    def validate(self):
        ...
        self.validate_required(self.step_status, 'step_status')
        self.validate_required(self.step_start_time, 'step_start_time')
    ...
    def from_map(self, map={}):
        self.step_name = map.get('StepName')
        self.step_status = map.get('StepStatus')
        self.step_start_time = map.get('StepStartTime')
        return self


class UpdateNatGatewayNatTypeRequest(TeaModel):
    def __init__(self, region_id=None, nat_gateway_id=None, v_switch_id=None, nat_type=None, dry_run=None,
                 client_token=None):
        self.region_id = region_id
        self.nat_gateway_id = nat_gateway_id
    ...
    def from_map(self, map={}):
        ...
        if map.get('Zones') is not None:
            for k in map.get('Zones'):
                temp_model = ListEnhanhcedNatGatewayAvailableZonesResponseZones()
...
class ListEnhanhcedNatGatewayAvailableZonesResponseZones(TeaModel):
...
class AllocateEipAddressRequest(TeaModel):
    def __init__(self, region_id=None, bandwidth=None, period=None, isp=None, activity_id=None, netmode=None,
                 ...
                 resource_group_id=None, client_token=None, service_uid=None, name=None, description=None):
        self.region_id = region_id
        self.bandwidth = bandwidth
        self.period = period
        self.isp = isp
    ...
    def from_map(self, map={}):
        ...
        self.resource_group_id = map.get('ResourceGroupId')
        self.client_token = map.get('ClientToken')
        self.service_uid = map.get('ServiceUid')
        self.name = map.get('Name')
        self.description = map.get('Description')
        return self
