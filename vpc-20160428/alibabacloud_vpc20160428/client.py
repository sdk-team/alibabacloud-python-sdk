...
class Client(RPCClient):
    ...
    def get_nat_gateway_convert_status_with_options(self, request, runtime):
        UtilClient.validate_model(request)
        return vpc_20160428_models.GetNatGatewayConvertStatusResponse().from_map(self.do_request("GetNatGatewayConvertStatus", "HTTPS", "POST", "2016-04-28", "AK", None, request.to_map(), runtime))
    ...
    def update_nat_gateway_nat_type_with_options(self, request, runtime):
        UtilClient.validate_model(request)
        return vpc_20160428_models.UpdateNatGatewayNatTypeResponse().from_map(self.do_request("UpdateNatGatewayNatType", "HTTPS", "POST", "2016-04-28", "AK", None, request.to_map(), runtime))
    ...
    def list_enhanhced_nat_gateway_available_zones_with_options(self, request, runtime):
        UtilClient.validate_model(request)
        return vpc_20160428_models.ListEnhanhcedNatGatewayAvailableZonesResponse().from_map(self.do_request("ListEnhanhcedNatGatewayAvailableZones", "HTTPS", "POST", "2016-04-28", "AK", None, request.to_map(), runtime))
