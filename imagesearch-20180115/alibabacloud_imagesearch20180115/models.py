...
class SearchItemResponseBodyAuctionsAuction(TeaModel):
    def __init__(self, cust_content=None, product_id=None, sort_expr_values=None, cat_id=None, pic_name=None):
...
class ItemAddResponseBody(TeaModel):
    def __init__(self, request_id=None, success=None, message=None, code=None):
        self.request_id = request_id
        self.success = success
        self.message = message
...
class ItemAddResponse(TeaModel):
    def __init__(self, headers=None, body=None):
        self.headers = headers
        self.body = body
    ...
    def from_map(self, map={}):
        self.headers = map.get('headers')
        if map.get('body') is not None:
            temp_model = ItemAddResponseBody()
            self.body = temp_model.from_map(map['body'])
        else:
            self.body = None
        return self
...
class UploadPicRequest(TeaModel):
    def __init__(self, headers=None, query=None):
        self.headers = headers
        self.query = query
...
class UploadPicResponse(TeaModel):
